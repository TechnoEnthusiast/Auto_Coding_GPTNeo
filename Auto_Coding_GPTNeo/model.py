...
class GPTSingleHead(nn.Module):
    """
    Different from directly using GPTNeoForCausalLM, this wraps up GPTNeoForCausalLM as well as GPT2Tokenizer
    """
    def __init__(self, model_name_or_path: str, max_seq_length: int = 256, do_lower_case: bool = False,
        ...
        self.gpt = GPTNeoForCausalLM.from_pretrained(model_name_or_path)
