...
MODEL_MAP = {"EleutherAI/gpt_neo_125M": "EleutherAI/gpt-neo-125M", "EleutherAI/gpt_neo_1.3B": "EleutherAI/gpt-neo-1.3B", "EleutherAI/gpt_neo_2.7B": "EleutherAI/gpt-neo-2.7B"}
...
if __name__ == '__main__':
    ...
    model.add_special_words({"pad_token": "<pad>", "additional_special_tokens": ["<examples>"]})
