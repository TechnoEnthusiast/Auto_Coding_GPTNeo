...
if __name__ == '__main__':
    ...
    #gpt2_tok = GPT2Tokenizer.from_pretrained("gpt2", do_lower_case=False) GPT Neo
    #gpt2_tok = GPT2Tokenizer.from_pretrained("EleutherAI/gpt-neo-1.3B")
    gpt2_tok = GPT2Tokenizer.from_pretrained("EleutherAI/gpt-neo-125M") #For Training Small GPT Neo Model.
    paths = ['examples']
    segments = {}
